...
- [ ] Tarefa: Mapear todas as ocorrências de tokens customizados (`text-text-primary`, `bg-bg-main`, `bg-primary-main`, etc.) em arquivos `.vue` e `.ts`.
- [ ] Tarefa: Identificar cores hardcoded (`dark:bg-[#...]`, `bg-black/`, etc.) que podem ser substituídas por tokens do preset.
- [ ] Tarefa: Conductor - User Manual Verification 'Fase 1: Análise e Mapeamento' (Protocol in workflow.md)
