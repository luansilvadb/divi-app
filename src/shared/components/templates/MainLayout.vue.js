...
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign(__assign({ 'onLogout': {} }, { class: "!hidden md:!flex" }), { user: (__VLS_ctx.user) })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({ 'onLogout': {} }, { class: "!hidden md:!flex" }), { user: (__VLS_ctx.user) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
var __VLS_5;
var __VLS_6 = ({ logout: {} },
    { onLogout: function () {
            var _a = [];
...
// @ts-ignore
var __VLS_17 = __VLS_asFunctionalComponent1(__VLS_16, new __VLS_16(__assign(__assign({ 'onClose': {} }, { 'onLogout': {} }), { isOpen: (__VLS_ctx.isMobileDrawerOpen), user: (__VLS_ctx.user) })));
var __VLS_18 = __VLS_17.apply(void 0, __spreadArray([__assign(__assign({ 'onClose': {} }, { 'onLogout': {} }), { isOpen: (__VLS_ctx.isMobileDrawerOpen), user: (__VLS_ctx.user) })], __VLS_functionalComponentArgsRest(__VLS_17), false));
var __VLS_21;
var __VLS_22 = ({ close: {} },
    { onClose: function () {
            var _a = [];
            ...
            // @ts-ignore
            [user, isMobileDrawerOpen, isMobileDrawerOpen,];
        } });
var __VLS_23 = ({ logout: {} },
    { onLogout: function () {
            var _a = [];
