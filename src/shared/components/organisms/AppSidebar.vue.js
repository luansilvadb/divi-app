...
var __VLS_11 = __VLS_9.slots.default;
{
    ...
    var _a = __VLS_vSlot(__VLS_12)[0], item = _a.item, props_1 = _a.props;
    if (item.separator) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "my-4 mx-6 border-t border-black/5 dark:border-white/5" }, { class: ({ 'hidden': __VLS_ctx.isCollapsed }) }));
            ...
            }], __VLS_functionalComponentArgsRest(__VLS_14), false));
        {
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.a, __VLS_intrinsics.a)(__assign(__assign(__assign({ onClick: (navigate) }, { href: (href) }), (props_1.action)), { class: ([
            ...
            if (isActive) {
                __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "absolute inset-0 bg-primary-main/5 blur-xl" }));
                /** @type {__VLS_StyleScopedClasses['absolute']} */ ;
                /** @type {__VLS_StyleScopedClasses['inset-0']} */ ;
                /** @type {__VLS_StyleScopedClasses['bg-primary-main/5']} */ ;
                /** @type {__VLS_StyleScopedClasses['blur-xl']} */ ;
            }
            __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: ([item.icon, isActive ? 'scale-110' : 'group-hover:scale-110']) }, { class: "text-xl transition-transform duration-300 relative z-10" }));
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "ml-3 font-medium truncate transition-all duration-300 relative z-10" }, { class: ({ 'opacity-0 w-0 hidden': __VLS_ctx.isCollapsed, 'font-bold': isActive }) }));
            ...
            if (item.badge) {
                ...
                badge_1.default;
                // @ts-ignore
                var __VLS_20 = __VLS_asFunctionalComponent1(__VLS_19, new __VLS_19(__assign(__assign({ class: "ml-auto relative z-10 transition-opacity duration-300" }, { class: ({ 'opacity-0 scale-0': __VLS_ctx.isCollapsed }) }), { value: (item.badge) })));
                var __VLS_21 = __VLS_20.apply(void 0, __spreadArray([__assign(__assign({ class: "ml-auto relative z-10 transition-opacity duration-300" }, { class: ({ 'opacity-0 scale-0': __VLS_ctx.isCollapsed }) }), { value: (item.badge) })], __VLS_functionalComponentArgsRest(__VLS_20), false));
            ...
            // @ts-ignore
            [isCollapsed, isCollapsed, isCollapsed, isCollapsed, isCollapsed, menuItems, vTooltip,];
            __VLS_16.slots['' /* empty slot name completion */];
        }
        var __VLS_16;
    }
    else if (item.action) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.a, __VLS_intrinsics.a)(__assign(__assign({ onClick: (item.action) }, (props_1.action)), { class: ([
        ...
        /** @type {__VLS_StyleScopedClasses['mb-1']} */ ;
        /** @type {__VLS_StyleScopedClasses['group']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: (item.icon) }, { class: "text-xl group-hover:scale-110 transition-transform duration-300" }));
        __VLS_asFunctionalDirective(__VLS_directives.vTooltip, {})(null, __assign(__assign({}, __VLS_directiveBindingRestFields), { modifiers: { right: true, }, value: (__VLS_ctx.isCollapsed ? item.label : undefined) }), null, null);
        /** @type {__VLS_StyleScopedClasses['text-xl']} */ ;
        /** @type {__VLS_StyleScopedClasses['group-hover:scale-110']} */ ;
        /** @type {__VLS_StyleScopedClasses['transition-transform']} */ ;
        /** @type {__VLS_StyleScopedClasses['duration-300']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "ml-3 font-medium truncate transition-all duration-300" }, { class: ({ 'opacity-0 w-0 hidden': __VLS_ctx.isCollapsed }) }));
        /** @type {__VLS_StyleScopedClasses['ml-3']} */ ;
        /** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
        /** @type {__VLS_StyleScopedClasses['truncate']} */ ;
        /** @type {__VLS_StyleScopedClasses['transition-all']} */ ;
...
}
{
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "px-7 py-3 text-[10px] font-black uppercase tracking-[0.2em] text-text-disabled mt-4 mb-1" }, { class: ({ 'opacity-0 h-0 p-0 hidden': __VLS_ctx.isCollapsed }) }));
...
[];
var __VLS_9;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "mt-auto px-4 mb-2 flex flex-col gap-2" }));
...
if (__VLS_ctx.user) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "user-profile transition-all duration-300 mx-2 p-2 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 flex items-center gap-3 cursor-pointer hover:bg-black/10 dark:hover:bg-white/10" }, { class: ({ 'justify-center !px-0 !mx-1': __VLS_ctx.isCollapsed }) }));
    /** @type {__VLS_StyleScopedClasses['user-profile']} */ ;
    /** @type {__VLS_StyleScopedClasses['transition-all']} */ ;
    /** @type {__VLS_StyleScopedClasses['duration-300']} */ ;
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "user-avatar min-w-[36px] h-[36px] rounded-full overflow-hidden flex-shrink-0 border-2 border-primary-main/20" }));
    /** @type {__VLS_StyleScopedClasses['user-avatar']} */ ;
    ...
    if (__VLS_ctx.user.avatar_url) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "w-full h-full bg-primary-main text-white flex items-center justify-center font-bold text-sm uppercase" }));
        /** @type {__VLS_StyleScopedClasses['w-full']} */ ;
        /** @type {__VLS_StyleScopedClasses['h-full']} */ ;
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "user-info flex flex-col overflow-hidden transition-all duration-300" }, { class: ({ 'opacity-0 w-0 hidden': __VLS_ctx.isCollapsed }) }));
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "text-[10px] text-text-secondary truncate" }));
    /** @type {__VLS_StyleScopedClasses['text-[10px]']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-text-secondary']} */ ;
    /** @type {__VLS_StyleScopedClasses['truncate']} */ ;
    (__VLS_ctx.user.email);
}
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "flex justify-center my-2" }));
/** @type {__VLS_StyleScopedClasses['flex']} */ ;
/** @type {__VLS_StyleScopedClasses['justify-center']} */ ;
...
// @ts-ignore
[isCollapsed, isCollapsed, user, user, user, user, user, user, user, user, user,];
