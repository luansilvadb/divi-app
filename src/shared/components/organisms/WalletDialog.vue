    ...
    >
      <div class="flex flex-col h-full">
        ...
        <div class="flex-1 overflow-y-auto pb-safe">
          <WalletFormContent :initial-data="wallet" @close="$emit('close')" @saved="handleSaved" />
        </div>
      </div>
    </NDrawer>
  </template>
...
import WalletFormContent from './WalletFormContent.vue'
