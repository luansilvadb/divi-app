...
var goalStore_1 = require("../../application/stores/goalStore");
...
var GoalCard_vue_1 = require("@/shared/components/molecules/GoalCard.vue");
var store = (0, goalStore_1.useGoalStore)();
var showAddGoalModal = (0, vue_1.ref)(false);
var globalProgress = (0, vue_1.computed)(function () {
    if (store.totalTarget <= 0)
        return 0;
...
(0, vue_1.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.fetchGoals()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var __VLS_6 = __VLS_3.slots.default;
{
    ...
    var __VLS_14 = ({ click: {} },
        { onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.showAddGoalModal = true;
                // @ts-ignore
                [showAddGoalModal,];
            } });
...
if (__VLS_ctx.store.goals.length === 0 && !__VLS_ctx.store.isLoading) {
    ...
    var __VLS_17 = __VLS_asFunctionalComponent1(__VLS_16, new __VLS_16({
        isEmpty: true,
        emptyTitle: "Sem metas ativas",
        emptySubtitle: "Você ainda não definiu nenhum objetivo financeiro. Que tal começar a poupar hoje?",
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-6" }));
    ...
    for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.store.goals)); _i < _a.length; _i++) {
        var goal = _a[_i][0];
        var __VLS_32 = GoalCard_vue_1.default;
        // @ts-ignore
...
var __VLS_44 = BaseSummaryItem_vue_1.default || BaseSummaryItem_vue_1.default;
// @ts-ignore
var __VLS_45 = __VLS_asFunctionalComponent1(__VLS_44, new __VLS_44({
    label: "Total Acumulado",
    value: (__VLS_ctx.formatCurrency(__VLS_ctx.store.totalSaved)),
...
{
    var __VLS_50 = __VLS_47.slots.icon;
    __VLS_asFunctionalElement1(__VLS_intrinsics.svg, __VLS_intrinsics.svg)({
        xmlns: "http://www.w3.org/2000/svg",
        width: "18",
        height: "18",
...
var __VLS_52 = __VLS_asFunctionalComponent1(__VLS_51, new __VLS_51({
    ...
    value: (__VLS_ctx.formatCurrency(__VLS_ctx.store.totalTarget)),
...
var __VLS_40;
var __VLS_63 = BaseCard_vue_1.default || BaseCard_vue_1.default;
// @ts-ignore
...
{
    var __VLS_69 = __VLS_66.slots.header;
    // @ts-ignore
    [];
}
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "w-8 h-8 rounded-lg bg-info-main/10 text-info-main flex-shrink-0 flex items-center justify-center" }));
/** @type {__VLS_StyleScopedClasses['w-8']} */ ;
/** @type {__VLS_StyleScopedClasses['h-8']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-lg']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-info-main/10']} */ ;
