...
var loanStore_1 = require("../../application/stores/loanStore");
...
var LoanCard_vue_1 = require("@/shared/components/molecules/LoanCard.vue");
var store = (0, loanStore_1.useLoanStore)();
var showAddLoanModal = (0, vue_1.ref)(false);
(0, vue_1.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.fetchLoans()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var handleDelete = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!confirm('Deseja realmente remover este registro? Esta ação não pode ser desfeita.')) return [3 /*break*/, 2];
                return [4 /*yield*/, store.deleteLoan(id)];
            case 1:
                _a.sent();
                _a.label = 2;
...
var __VLS_6 = __VLS_3.slots.default;
{
    ...
    var __VLS_14 = ({ click: {} },
        { onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.showAddLoanModal = true;
                // @ts-ignore
                [showAddLoanModal,];
            } });
...
if (__VLS_ctx.store.loans.length === 0 && !__VLS_ctx.store.isLoading) {
    ...
    var __VLS_17 = __VLS_asFunctionalComponent1(__VLS_16, new __VLS_16({
        isEmpty: true,
        emptyTitle: "Nenhum empréstimo registrado",
        emptySubtitle: "Você está livre de dívidas registradas no momento. Ótimo sinal!",
    ...
    for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.store.loans)); _i < _a.length; _i++) {
        var loan = _a[_i][0];
        var __VLS_32 = LoanCard_vue_1.default;
        // @ts-ignore
        var __VLS_33 = __VLS_asFunctionalComponent1(__VLS_32, new __VLS_32(__assign({ 'onDelete': {} }, { key: (loan.id), loan: (loan) })));
        var __VLS_34 = __VLS_33.apply(void 0, __spreadArray([__assign({ 'onDelete': {} }, { key: (loan.id), loan: (loan) })], __VLS_functionalComponentArgsRest(__VLS_33), false));
        var __VLS_37 = void 0;
        var __VLS_38 = ({ delete: {} },
...
{
    var __VLS_45 = __VLS_42.slots.header;
    // @ts-ignore
    [];
}
...
var __VLS_46 = BaseSummaryItem_vue_1.default || BaseSummaryItem_vue_1.default;
// @ts-ignore
var __VLS_47 = __VLS_asFunctionalComponent1(__VLS_46, new __VLS_46({
    label: "Dívida Total",
    value: (__VLS_ctx.formatCurrency(__VLS_ctx.store.totalDebt)),
...
{
    var __VLS_52 = __VLS_49.slots.icon;
    __VLS_asFunctionalElement1(__VLS_intrinsics.svg, __VLS_intrinsics.svg)({
        xmlns: "http://www.w3.org/2000/svg",
        width: "18",
        height: "18",
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "text-xl font-black tracking-tight text-text-primary" }));
/** @type {__VLS_StyleScopedClasses['text-xl']} */ ;
/** @type {__VLS_StyleScopedClasses['font-black']} */ ;
/** @type {__VLS_StyleScopedClasses['tracking-tight']} */ ;
/** @type {__VLS_StyleScopedClasses['text-text-primary']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "text-[0.7rem] font-bold text-text-disabled mt-1" }));
