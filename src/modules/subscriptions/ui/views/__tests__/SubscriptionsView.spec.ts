...
describe('SubscriptionsView', () => {
  ...
  beforeEach(() => {
    ...
    ;(useSubscriptionStore as unknown).mockReturnValue(storeMock)
  })
  ...
  it('exposes searchEmptySubtitle computed property', () => {
    ...
    expect((wrapper.vm as unknown).searchEmptySubtitle).toBe('Não encontramos assinaturas para "Netflix"')
  })
})
