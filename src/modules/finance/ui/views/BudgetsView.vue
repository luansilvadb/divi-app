    ...
    <div class="view-content-grid">
      ...
      <main class="main-column">
        ...
        <div
          ...
          class="empty-state glass-card p-12 text-center flex flex-col items-center justify-center"
        >
          <div class="empty-content max-w-md">
            ...
            <h3 class="text-2xl font-black text-text-primary tracking-tight mb-3">
              Nenhum orçamento ativo
            </h3>
            <p class="text-text-secondary text-sm leading-relaxed mb-8">
              Crie limites para controlar melhor seus gastos essenciais, conforto e investimentos.
            </p>
            <BaseButton variant="primary" @click="showAddBudgetModal = true">
              Começar a organizar
            </BaseButton>
        ...
        <BaseCard>
          ...
          <div class="rule-explanation flex flex-col gap-6 pt-2">
            <p class="rule-intro text-sm text-text-secondary font-medium leading-relaxed">
              A maneira mais simples de organizar suas finanças mantendo equilíbrio entre presente e
              futuro.
            </p>
            ...
            <ul class="rule-timeline relative flex flex-col gap-6 pl-6 list-none p-0 m-0">
              <!-- Vertical Line -->
              <div
                class="absolute top-2 bottom-2 left-1.5 w-0.5 bg-black/5 dark:bg-white/5 rounded-full"
              ></div>

              <li class="timeline-item flex gap-4 relative">
                <div
                  class="timeline-marker w-3 h-3 rounded-full bg-white border-2 border-primary-main shadow-sm z-10 mt-1"
                ></div>
                <div class="timeline-content">
                  <h4 class="text-sm font-black text-primary-main uppercase tracking-widest mb-1">
                    50% Essenciais
                  </h4>
                  <p class="text-xs text-text-disabled font-medium leading-relaxed">
                    Moradia, contas básicas, mercado, saúde e transporte.
                  </p>
                </div>
              </li>
              <li class="timeline-item flex gap-4 relative">
                <div
                  class="timeline-marker w-3 h-3 rounded-full bg-white border-2 border-warning-main shadow-sm z-10 mt-1"
                ></div>
                <div class="timeline-content">
                  <h4 class="text-sm font-black text-warning-main uppercase tracking-widest mb-1">
                    30% Estilo de Vida
                  </h4>
                  <p class="text-xs text-text-disabled font-medium leading-relaxed">
                    Lazer, hobbies, restaurantes, streaming e viagens.
                  </p>
                </div>
              </li>
              <li class="timeline-item flex gap-4 relative">
                <div
                  class="timeline-marker w-3 h-3 rounded-full bg-white border-2 border-success-main shadow-sm z-10 mt-1"
                ></div>
                <div class="timeline-content">
                  <h4 class="text-sm font-black text-success-main uppercase tracking-widest mb-1">
                    20% Futuro
                  </h4>
                  <p class="text-xs text-text-disabled font-medium leading-relaxed">
                    Reserva, quitação de dívidas e investimentos.
                  </p>
                </div>
              </li>
            </ul>
