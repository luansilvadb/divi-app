          ...
          <div class="flex flex-col gap-8 pt-2">
            ...
            <div class="mt-4 pt-6 border-t border-black/5 dark:border-white/5">
              <div class="flex justify-between items-end mb-4">
                <span class="text-[0.7rem] font-black uppercase tracking-widest text-text-disabled"
                  >Conclusão Geral</span
                >
                <span class="text-3xl font-black text-primary-main tracking-tighter leading-none"
                  >{{ totalProgressFormatted }}%</span
                >
              </div>
              <BaseProgressBar
              ...
              />
              <p
                class="text-xs font-medium text-text-disabled mt-5 leading-relaxed"
                v-if="Number(totalProgressFormatted) < 100"
              >
                Faltam
                <span class="font-black text-text-secondary">{{
        ...
        <BaseCard>
          ...
          <div class="flex flex-col gap-6 pt-2">
            <p class="text-sm text-text-secondary font-medium leading-relaxed">
              Pequenas ações diárias que aceleram seus objetivos de longo prazo.
            </p>

            <ul class="rule-timeline relative flex flex-col gap-8 pl-8 list-none p-0 m-0">
              <!-- Vertical Line -->
              <div
                class="absolute top-2 bottom-2 left-2 w-0.5 bg-black/5 dark:bg-white/5 rounded-full"
              ></div>

              <li class="timeline-item flex gap-4 relative">
                <div
                  class="timeline-marker w-4 h-4 rounded-full bg-white border-2 border-primary-main/40 flex items-center justify-center shadow-sm z-10 mt-1"
                >
                  <div class="w-1.5 h-1.5 rounded-full bg-primary-main"></div>
                </div>
                <div class="timeline-content">
                  <h4
                    class="text-[10px] font-black text-primary-main uppercase tracking-widest mb-1.5"
                  >
                    Constância é Chave
                  </h4>
                  <p class="text-xs text-text-disabled font-medium leading-relaxed">
                    Aportes pequenos e regulares vencem grandes aportes esporádicos.
                  </p>
                </div>
              </li>
              ...
              <li class="timeline-item flex gap-4 relative">
                <div
                  class="timeline-marker w-4 h-4 rounded-full bg-white border-2 border-accent-main/40 flex items-center justify-center shadow-sm z-10 mt-1"
                >
                  <div class="w-1.5 h-1.5 rounded-full bg-accent-main"></div>
                </div>
                <div class="timeline-content">
                  <h4
                    class="text-[10px] font-black text-accent-main uppercase tracking-widest mb-1.5"
                  >
                    Proteja seus Sonhos
                  </h4>
                  <p class="text-xs text-text-disabled font-medium leading-relaxed">
                    Priorize sua reserva de emergência antes de iniciar metas de prazer.
                  </p>
                </div>
              </li>
              ...
              <li class="timeline-item flex gap-4 relative">
                <div
                  class="timeline-marker w-4 h-4 rounded-full bg-white border-2 border-secondary-main/40 flex items-center justify-center shadow-sm z-10 mt-1"
                >
                  <div class="w-1.5 h-1.5 rounded-full bg-secondary-main"></div>
                </div>
                <div class="timeline-content">
                  <h4
                    class="text-[10px] font-black text-secondary-main uppercase tracking-widest mb-1.5"
                  >
                    Visualize a Vitória
                  </h4>
                  <p class="text-xs text-text-disabled font-medium leading-relaxed">
                    Revise suas metas semanalmente para manter o foco inabalável.
                  </p>
                </div>
              </li>
            </ul>
