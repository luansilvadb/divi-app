...
describe('DexieBudgetRepository', () => {
  ...
  it('should save and get active budgets', async () => {
    await repo.save({ id: 'b1', category_id: 'c1', limit_value: 100, period: 'monthly', deleted: false } as any)
    await repo.save({ id: 'b2', category_id: 'c2', limit_value: 200, period: 'monthly', deleted: true } as any)
