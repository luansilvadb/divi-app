...
(0, vitest_1.describe)('App', function () {
    (0, vitest_1.it)('mounts renders properly', function () { return __awaiter(void 0, void 0, void 0, function () {
        var pinia, wrapper;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pinia = (0, pinia_1.createPinia)();
                    wrapper = (0, test_utils_1.mount)(App_vue_1.default, {
                        global: {
                            plugins: [pinia, router_1.default],
                        },
                    });
                    // Wait for router
                    return [4 /*yield*/, router_1.default.isReady()];
                case 1:
                    // Wait for router
                    _a.sent();
