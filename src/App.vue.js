...
if (__VLS_ctx.isLoggedIn && !__VLS_ctx.isLoginRoute) {
    ...
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign({ 'onLogout': {} })));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ 'onLogout': {} })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    var __VLS_5 = void 0;
    var __VLS_6 = ({ logout: {} },
    ...
    // @ts-ignore
    [isLoggedIn, isLoginRoute, handleLogout,];
    var __VLS_3;
    var __VLS_4;
}
else {
