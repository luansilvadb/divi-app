...
- [x] T005 [P] [US1] Add patterns for private keys and certificates (_.key, _.pem, \*.p12) in .gitignore
...
- [x] T013 [P] [US3] Create "# Local Databases" section with _.db and _.sqlite patterns in .gitignore
