...
O projeto deve utilizar obrigatoriamente: Vue 3 (Composition API), TypeScript (Strict Mode), Pinia (State Management), Supabase (Backend-as-a-Service) e Vite (Build Tool).
