...
description: "Captures learnings, errors, and corrections to enable continuous improvement. Use when: (1) A command or operation fails unexpectedly, (2) User corrects GEMINI ('No, that's wrong...', 'Actually...'), (3) User requests a capability that doesn't exist, (4) An external API or tool fails, (5) GEMINI realizes its knowledge is outdated or incorrect, (6) A better approach is discovered for a recurring task. Also review learnings before major tasks."
---
...
| Broadly applicable learning | Promote to `GEMINI.md` and/or `AGENTS.md` |
...
- `promoted` - Elevated to GEMINI.md or AGENTS.md
...
|--------|-------------------|
| `GEMINI.md` | Project facts, conventions, gotchas for all GEMINI interactions |
...
3. **Update** original entry:
   ...
   - Add `**Promoted**: GEMINI.md` or `**Promoted**: AGENTS.md`
...
4. **Consider systemic fix**: Recurring issues often indicate:
   - Missing documentation (→ promote to GEMINI.md)
...
7. **Promote aggressively** - if in doubt, add to GEMINI.md
